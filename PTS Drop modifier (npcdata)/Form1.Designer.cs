...
namespace PTS_Drop_modifier__npcdata_
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.label2.Text = "specially for mmo-dev.info";
			...
			this.label3.Text = "telegram: @obi_us";
			// 
			// label4
			// 
			this.label4.Location = new System.Drawing.Point(199, 274);
			this.label4.Name = "label4";
			this.label4.Size = new System.Drawing.Size(73, 21);
			this.label4.TabIndex = 4;
			this.label4.Text = "icq:  8287735";
			// 
			// Form1
			// 
